...
didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer
    ...
    ZoomVideoSDKVideoRawDataRotation rotate = ZoomVideoSDKVideoRawDataRotationNone;
    ...
    switch (orientation)
    {
        case UIInterfaceOrientationLandscapeLeft:
            rotate = ZoomVideoSDKVideoRawDataRotationNone;
            break;
            
        case UIInterfaceOrientationPortraitUpsideDown:
            rotate = ZoomVideoSDKVideoRawDataRotation270;
            break;
            
        case UIInterfaceOrientationLandscapeRight:
            rotate = ZoomVideoSDKVideoRawDataRotation180;
            break;
            
        case UIInterfaceOrientationPortrait:
            rotate = ZoomVideoSDKVideoRawDataRotation90;
            break;
